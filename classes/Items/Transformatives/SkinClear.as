			...
			switch(selTF)
			{
				...
				case 2:
					...
					if(!target.isBro())
					{
						...
						output(" A low groan works it way out of your clenched [pc.teeth], feeling the results of your frantic masturbation session begin to build up in your [pc.balls].");
