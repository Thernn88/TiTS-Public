...
public function configureCodex():void
{
	...
	CodexManager.addCodexEntry(CodexManager.CODEX_TYPE_RACE, "Core Worlds", "Vysp", vyspCodexEntry);
...
public function vyspCodexEntry():void
{
	clearOutputCodex();
	showBust();
	outputCodex(header("Vysp"));
	outputCodex("<i>“Territorial, dominant, long-lived, harem queens. Or, as referred to on the Extranet, the best damned cocksuckers in the galaxy.”</i>");
	outputCodex("\n\n");
	outputCodex("<b>Name (Singular & Plural):</b> Vysp");
	outputCodex("\n<b>Sexes:</b> Hermaphrodite. A colony contains one reproductive queen and numerous sterile workers.");
	outputCodex("\n<b>Height:</b> Height ranges between 5' to 7', Queens in later forms are much larger, ranging from 9-12' in their adolescent stage and 14'-18  when fully mature.");
	outputCodex("\n<b>Weight:</b> Sterile: 200-400 lbs Queens: 1000 lbs+");
	outputCodex("\n<b>Skin:</b> Covered from head to toe in thick, segmented chitin. Can be black, blue, red or white.");
	outputCodex("\n<b>Face:</b> Covered in chitin. Same possible color variation as skin but will never match. ");
	outputCodex("\n<b>Arms:</b> Four chitinous arms with four fingers and a thumb.");
	outputCodex("\n<b>Legs:</b> Two chitinous legs ending in a tripod shaped foot.");
	outputCodex("\n<b>Antenna:</b> Vysp possess a pair of antenna atop their head which act as the functional equivalent of ears and a nose.");
	outputCodex("\n<b>Breasts:</b> Two, four in mature queen. B - D in steriles and young queen but growing larger as she matures. Fleshy external growths on the chitin covering their torso which are sustained through joints in the plates.");
	outputCodex("\n<b>Wings:</b> Vysp possess four powerful, orange membranous wings capable of flight.");
	outputCodex("\n<b>Eyes:</b> Four to six eyes of red, black or gold coloration. Hardened externally with an moveable internal glowing, red pupil. Sterile and young queens possess four eyes on their face. Queens gain an additional eye on each side of their head after first pupation. ");
	outputCodex("\n<b>Abdomen:</b> Vysp have a large, chitinous abdomen.");
	outputCodex("\n<b>Average Lifespan:</b> Steriles: 100-200 years. Queens: 10,000+ years.");
	outputCodex("\n<b>Homeworld:</b> Xyv");
	outputCodex("\n\n");
	outputCodex(blockHeader("Appearance"));
	outputCodex("In U.G.C. territory, vysp are considered the most nonhuman insectoid race. The race is completely covered with chitinous plates and unlike many other insectoid races has no hair. This covering evolved alongside denser bones and stronger muscles required to carry the weight of these plates. These plates make a vysp, especially a mature queen with passive regeneration, a formidable foe.");
	outputCodex("\n\nThe trait for which vysp are most well known is their mouth. Closed the only evidence of a vysp mouth's vast extent is a thin line running through their lips. Fully open it stretches nearly the length of their face, this extreme articulation enabled by additional hinges in their jaw. Vysp have no teeth, instead they possess two sets of mandibles which lay flat against their cheeks. Additionally, they have an elastic throat capable of expansion. This combination of features give vysp a reputation as the 'best cocksuckers in the galaxy'. One particular queen enjoys highlighting as a hyperporn starlet in which she orally services and deepthroats hypersized members.");
	outputCodex("\n\nBecause of these traits, some may accuse vysp of violating U.G.C Universal Mandate 57, prohibiting the knowing consumption of sentient life. Vysp find the concept abhorrent, their distaste for the act so strong it may even be genetic. To them the consumption of sentient life is the ultimate waste. Instead, a vysp would rather incorporate a sentient individual into their colony and broaden the genetic diversity of the queen's harem or of their client races.");
	outputCodex("\n\nLike many other insectoid races, vysp possess an abdomen. Unlike them most of their internal organs, including their entire reproductive system, are located inside. Only a vysp's brain and stomach exist wholly outside this appendage. Their torso is almost completely comprised of the dense musculature required to power their wings. A vysp abdomen is equipped with a reproductive organ most easily classified as an ovipositor, but it is also used for insemination or as a canal for fertilization. Additionally, the abdomen contains a retractable stinger able to deliver a potent aphrodisiac effective in almost 95% of known races.");
	outputCodex("\n\nThe circulatory and respiratory needs of such a demanding body required a creative solution. Vysp have evolved a multi-heart system with one in the head, another in the torso and a third in the abdomen. More unusual is their distributed system of air sacs throughout the body acting as miniature lungs. Vysp take in air through sealable tracheal holes on their head and chest. It is released, along with pheromones and the intense heat their musculature generates, through similar holes on their abdomen. Together, these two systems work to ensure oxygen is nearby and blood is rapidly pumped to deliver it to starved muscle.");
	outputCodex("\n\n");
	outputCodex(blockHeader("History & Society"));
	outputCodex("Vysp are a colonial insectoid species centering around one reproductive hermaphrodite individual. They originate from the large, rocky, metal-rich desert world of Xyv. Approximately a million years ago, Xyv was a lush forested world. However, a rogue star passing through the system shifted Xyv's orbit. The resulting ecological cataclysm caused the biological capacity of the world to begin a steady decline.");
	outputCodex("\n\nPrior to the cataclysm vysp were a sentient, but solitary, and territorial insect species with a lifespan comparable to most other humanoid races. They coexisted on the world with 4 other sentient races: the Xidi, Phooki, Orwit and Hasr. Two of these races, the Xidi and the Orwit, had even entered their own equivalent of an early industrial revolution. It is thanks to them and the stability of vysp colonies that Xyvian races have the longest recorded history of all U.G.C member races.");
	outputCodex("\n\nReproductive vysp possess a high libido, but due to their territorial instincts could not find consistent relief with other members of their species. Thus to achieve release, pre-cataclysm vysp would accost travelers of other races and forcibly mate with them. Some vysp would even abduct males and females and create their own harem. The other sentient species tolerated these forced matings and occasional abductions simply because vysp queens were hard to kill. Regarded as a genetic quirk, couplings between vysp and other species produced sterile vysp which could be influenced by the queen's pheromones.");
	outputCodex("\n\nWhen the cataclysm struck, it was the vysp who emerged the savior of the other four races. Vysp spit when mixed with dirt and organic matter produces an excellent building material that rivals and even surpasses many modern alloys. Several queens are recorded as attempting to fashion primitive city-states utilizing sterile offspring as a workforce. After the cataclysm began, these structures proved extraordinarily resistant to the sandstorms. It was these queens ,and almost a hundred others deemed likely receptive, that the other four races approached and entered into a mutual agreement which ensured the survival of all");
	outputCodex("\n\nEach vysp queen would form the center of a colony and communities of the client races would organize around them. The queen would choose mates from among these communities to breed with and produce sterile vysp to create the protective structures. In turn, client races were charged with the production of food and other necessities. Although the rise of modern society has brought with it the addition of new societal roles, these two roles remain largely in place. Thus construction, including most starship construction, on vysp worlds is the domain of vysp while food production is the domain of the client races. Large, organic cities and spaceships are ubiquitous with vysp controlled space.");
	outputCodex("\n\nAs the planet's environment continued to degrade, the sandstorms which ravaged all of Xyv began lasting longer and longer. As their duration grew, the lifespan of queens and the Vysp reproductive cycle was forced to adapt in response. Shorter lived queens or those with off-timed cycles did not survive to reproduce. Approximately 100,000 years ago, the sandstorm cycle stabilized with sandstorms lasting ~950 years with a 50 year interval before the next. During this 50 year cycle, vysp queens enter a type of heat, greatly reducing their territorial instincts and enabling them to congregate centrally and mate to propagate their race.");
	outputCodex("\n\nThese sandstorms amplified several other traits already present in the vysp race, in particular the dominance of queens, submissiveness of the sterile caste and the territorial reaction of a queen toward another reproductive vysp. Dominance in queens was necessary to rule large city states. Concurrently, submissiveness in the sterile caste created a peaceful and expendable workforce. Territoriality, ensured queens protected the investment that was their city-state against aggressor queens.");
	outputCodex("\n\nTechnological growth of the vysp and their client races was extremely slow, hampered by nearly incessant sandstorms and lack of communication between city-states. Around 10,000 years ago, however, the invention of electromagnetic communication and it's subsequent spread during the ritual meeting brought an immediate boom in technological progress. Now able to communicate during the raging storms, vysp colonies were free to share ideas and scientific knowledge. In only 500 years, dozens of space elevators littered the surface of Xyv.");
	outputCodex("\n\nThe long lifespan of vysp queens made them a perfect organism to utilize colony ship distribution. Vysp worlds would launch a dozen colony ships toward a nearby star. Onboard each ship was a single adolescent queen along with client races. Even with sublight drives operating at 5% the speed of light, reaching a nearby star only took several hundred years. This short period was nothing compared to the long lifespan of a vysp queen and her presence ensured each colony ship had stable, continual governance.");
	outputCodex("\n\nThe 9th galactic rush marked the least successful expansion in U.G.C. history. Repeatedly, ships would jump into systems only to encounter large fleets at the gate and find vysp colonized worlds. By the the time the U.G.C encountered them, the vysp controlled nearly three hundred systems and possessed over a hundred client races. Fearful of a war that would dwarf the Thraggen conflict, U.G.C. leadership quickly negotiated membership. The huge number of vysp controlled systems made them an immediate powerhouse in galactic politics, almost approaching Human, Asuar and Anatae spheres in influence, and their continual colonization efforts each rush ensure they remain one of the largest factions to this day.");
	outputCodex("\n\nVysp controlled systems continually rank among the top U.G.C systems in which to live. Metrics for crime, piracy, poverty, joblessness are all low, while metrics such as happiness, safety and satisfaction towards vysp governance are high. Scholars attribute much of the success of vysp colonies to the long lifespan of queens, which encourages them to seek long-term solutions to any potential issue. Additionally, vysp space is well protected, as a vysp queen's ranking in the societal hierarchy is determined by how many ships she can crew and commit to the Vysp Grand Fleet. This ensures continual competition between queens and provides the vysp with a fleet rivaling that of the Humans, Ausar or Anatae in size.");
	outputCodex("\n\nOf further note, is that after the granting of membership, vysp continually insisted the U.G.C take measures on non-vysp worlds to ensure queens never meet. The infamous incident on Oohshi Prime, brought about by negligent planetary leadership, was a stark example as to why. Hundreds died, collateral damage of the fight between the two rampaging queens. A landmark Galactic Supreme Court decision found the involved queens not guilty, as a race could not be held accountable for involuntary racial instincts. This decision led to U.G.C Universal Mandate 358 which expressly prohibits more than one queen on non-vysp worlds at any time.");
	outputCodex("\n\n");
	outputCodex(blockHeader("Sex and Reproduction"));
	outputCodex("In Vysp reproduction 90% of the DNA originates from the maternal parent, while 10% is derived paternally. In order to produce a reproductive vysp two queens must mate, otherwise the resulting offspring is sterile. Vysp queens maintain a sizable personal harem which provides them a large genetic pool from which they can sample. This allows them to predictably produce sterile young with desirable traits of other species. Vysp eggs can be fertilized by males of over 99% of known species. Vysp sperm, however, is almost universally unable to impregnate females, with only a few singular exceptions such as kerokoras, f'hani and the newly discovered vanae and sacae. In these cases any resulting child is always a member of the maternal race.");
	outputCodex("\n\nVysp reproduction occurs entirely in the abdomen, through a single genital opening. When relaxed vysp genitals look nearly identical to the vaginal opening of most other humanoid races. Through this opening males of other species, or another vysp queen, can mate with a vysp and inseminate their eggs. All vysp are consciously capable of reversing this canal and extending it outside to function as an ovipositor or an inseminating organ.");
	outputCodex("\n\nWhile queens are not required to lay fertilized eggs inside a female partner, they usually do. In early colonial days it was discovered laying their eggs inside a female vastly sped up the hatching process. Multiple sources describe the sensation of a queen ovipositing inside one's womb along with the actual birth process as mind-blowingly orgasmic.");
	outputCodex("\n\nVysp queens will often stud favored male, female or herm members of their harem to ensure the continuation of breeding lines. They are not jealous lovers as, since their harems are typically large, they are unable to see to all their partners' sexual needs. Thus they allow lovers to take on other partners as long as they are available when the queen needs or desires them. Universally throughout vysp worlds it is considered a great honor to be taken as a member of a queen's harem, and the social desirability of harem members as a sexual partner or mate is very high.");
	outputCodex("\n\nWhile sterile vysp are not capable of reproduction, it does not mean they do not enjoy or desire sex. A near ubiquitous feature of vysp colonies is the housing of one vysp worker in each household. The vysp worker is treated as an additional spouse of the household members. The vysp will contribute to the upkeep of the household, help care for offspring of the client species and is included in household decisions. As a spousal member, they will also engage sexually with their two partners or possibly more depending on the social customs of the client species.");
	outputCodex("\n\nThe submissiveness of the vysp worker and their sterile status prevents almost all conflicts that an additional partner could conceivably cause, even in traditionally strict monogamous species. Research has found vysp workers release subtle pheromones which encourage their initial acceptance, integration into the house and their inclusion in sexual activities.");
	CodexManager.viewedEntry("Vysp");
}
