...
public function sylvieTriesHerDongerOn3():void
{
	...
	if(pc.cockTotal() == 1) output("\n\nYour own [pc.cock] flexes and strains while you cum impossibly hard, your muscles tensing so tightly that you hear Sylvie mixing in some appreciative moans with her insensate, animalistic grunting, but nothing comes out of the tip. [pc.teeth] grit, prick fully erect and throbbing, you’re fucked to a dry orgasm by the relentless pounding from below.");
	else if(pc.hasCock()) output("\n\nYour own [pc.cocks] flex and strain while you cum impossibly hard, your muscles tensing so tightly that you hear Sylvie mixing in some appreciative moans with her insensate, animalistic grunting, but nothing comes out of the tips. [pc.teeth] grit, prick fully erect and throbbing, you’re fucked to a dry orgasm by the relentless pounding from below.");
	else if(pc.hasVagina())
	{
...
public function sylvieGloryholeSuck():void
{
	...
	if(pc.isTreated()) output(" You shiver in pleasure when she slips a couple of inches inside, your Treated body rewarding you for doing such a good job for your master. Your eyes roll back in your head when her thick flare pops past your back [pc.teeth], conforming to the opening of your throat. This’ll be fun!");
	else output("This is fucking hard! You almost gag when she’s a couple of inches inside, risking losing your precious progress, but manage to fight off the urge. With immense relief, you feel her thick flare pop past your back [pc.teeth] and conform to the opening of your throat.");
