...
public function tapKallysKegAsBimboII():void
{
	...
	output(".");
	output("\n\nYou don’t make the mistake of opening too wide. You don’t remember why; you just do it. Your lips stay nice and tight around the cock, your mouth dilated just enough to keep your [pc.teeth] from grazing the tender skin. Then you slide forward, accepting her inside. She is <i>thick</i>. Thick enough that it feels like she’s too wide for your meager tongue. Thick enough that her fat dick must have your [pc.lips] shaped into an absolutely obscene shape. Your average terran would never be able to accomplish such a feat, and for that matter, most kui-tan couldn’t either.");
	//Random
...
public function rahnMilkerFunTimes(arg:String):void
{
	...
	output("\n\nThe kiss is rudely broken by the sudden appearance of an interloper: Kally. The bustier sister has leaned over from her side of the milking parlor and pulled Kiro away - and into her own lips. The pirate doesn’t care, not so long as she’s kissing somebody. Her tail wags, slapping your [pc.butt] repeatedly. They make out right in front of you, leaving you to watch the incestuous display of sapphic desire. You could light a candle by the molten heat of the ardor.");
