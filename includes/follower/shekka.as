...
public function oviEggShekka():void
{
	...
	else
	{
		...
		output(". Shekka sighs, riding the extra sensations for all they’re worth, content to ride her euphoria till you finish. You grit your [pc.teeth], holding the lusky raskvel tight as you prepare for what comes next. Her orgasm induced lethargy isn’t enough to fully distract her as the first egg works its way through your ovicock and pushes into her womb.");
