...
public function catchVaginalFromKiro():void
{
	...
	else
	{
		...
		if(pc.totalVaginas() == 1) output("s");
		output(". You need to be fucked, and fucked hard, plowed so roughly that your twat’ll rattle bliss all the way up to your [pc.teeth]. And maybe, just maybe, you’ll manage to stay conscious the entire time Kiro floods your ");
