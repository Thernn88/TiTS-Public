...
public function uvetoCarbonadoHelpGwen():void
{
	...
	else
	{
		...
		output("\n\nYou swiftly take advantage of this vulnerable teat, nibbling gently and letting your [pc.teeth] graze the sensitive nub. At the same time you slide your fingers over her lips and into her sopping cunt, eliciting a shocked cry from the pudgy puazi. She arches forward, trying futilely to resist the urges beckoning her to blissful oblivion.");
...
public function cfsGoSleepover():void
{
	...
	else
	{
		...
		output(", and gasp as she begins to work her way into your sex with her tongue. She clutches at your hips, attempting to drag them closer with all the strength she can muster. You clench your [pc.teeth] to stifle a moan as she alternates between taking heaving breaths and facefucking your crotch. Twinging beacons of bliss race through your body as her chin and lower lip rub relentlessly at your [pc.clit]");
...
public function cfsHolidayShoppingIII():void
{
	...
	if(!pc.isTaur())
	{
		...
		else
		{
			...
			output("\n\nYour partner lets out an elated gasp as a spurt of [pc.cum] gushes from [pc.cockBiggest], the herald of what's to come. You grit your [pc.teeth] as the full flood follows, ");
	...
	else
	{
		...
		if(pc.hasCock())
		{
			...
			output("\n\nYou struggle to form thoughts. 'No. don't! There are people watching', But these rational reactions are swiftly beaten away by the baser impulses. 'Feel good. More, <b>Cum!</b>' Your eyes roll back, and you grit your [pc.teeth] as the last command reaches your sex. Spurts of [pc.cum] shoot from [pc.eachCock], ");
		...
		else
		{
			...
			output("\n\nYou struggle to form thoughts. 'Wait. This isn't the time. So many people watching', But all these rational thoughts swiftly lose out to the baser impulses. 'So good. Maybe if I just <b>Cum</b> a little bit!' Your eyes cross, and you grit your [pc.teeth] as the last command hits [pc.eachVagina]. ");
