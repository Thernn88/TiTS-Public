...
public function dontLetTheMilodanGetOffHesADork(x:int):void
{
	...
	{
		output(" you begin to dump the first of many massive loads into his ass, drowning his insides in warm seed and marking him as yours. You keep thrusting, [pc.teeth] gritted as your bountiful orgasm continues. You rapidly fill up his tummy, his hands wrapped around his swollen midriff as the excess begins to drip, stream, and then spray back out around your cock.");
...
public function yesGetTheMilodanOff(x:int):void
{
	...
	output("\n\nHe groans loudly, the almost-clear color of his pre-cum swiftly changing to a thick, milky white as it starts to spurt out in heavy ropes. He shudders around your cock, his hole contracting and seizing around your immovable rod deep inside him. You grit your [pc.teeth] and manage to hold out, staving off your orgasm - you <i>really</i> want to get him off more than once, show him how fun being your anal slut can be.");
	...
	output("\n\nYou grit your [pc.teeth] and groan in satisfaction as you finally let yourself go, your backed-up load spurting into the milodan’s ass and coating his insides in spunk. Giving him a few last lazy thrusts,");
	...
	else
	{
		...
		{
			output(" You dump your first massive load into his ass with a grunt, swelling his ring every time your cumvein carries your next bulging barrelful of jizz into his warm insides. Groaning, you push into him as deep as you can, pressing into his ass to get your seed as far inside him as it’ll go. You grit your [pc.teeth] as your knot begins to inflate, truly trapping him below you. ");
...
public function taurssionaryWithFloofyBoyslut():void
{
	...
	if(vIdx >= 0) output("rub your [pc.clits " + vIdx + "], bringing you to thunderous orgasm in a matter of seconds. You unconsciously buck your hips, gritting your [pc.teeth] as the rush of endorphins floods your body. The barbarian holds you down with a firm hand on your stomach, keeping you grounded while your back arches and your voice comes out in high-pitched moans.");
	else output("jack your [pc.cock], bringing you to a back-arching orgasm in a matter of seconds. Your legs flex and shake as you grit your [pc.teeth] and grunt, [pc.cumColor] [pc.cum] spurting across your underside as the rush of endorphins floods your body. The barbarian holds you down with a firm hand on your stomach, keeping you grounded while he continues stroking your prostate with his cock and your voice comes out in stumbling utterances.");
...
public function pussyWrasslin(vIdx:int = 0):void
{
	...
	else if(!pc.isTaur())
	{
		...
		output("\n\nEvery time he pounds your wet, slick passage you can feel the base of his cock begin to swell just enough to be noticeable, forcing your folds apart and spreading you wide for him. With each dominant push it grows just that little bit more, and soon enough your lusty moans give way to exhalations through gritted [pc.teeth] and groans of exertion. It feels like his knot is hollowing you out, the milodan refusing to let it rest anywhere outside of your pussy and only giving you scant seconds to get used to its inflated bulk before he pulls it out and rams it back in.");
...
public function cockwrassleTheMilodanMale():void
{
	...
	else if(!pc.isTaur())
	{
		...
		output(".");
		output("\n\nEvery time he pounds your slickening passage you can feel the base of his cock begin to swell just enough to be noticeable, forcing your ring apart and spreading you wide for him. With each dominant push it grows just that little bit more, and soon enough your lusty moans give way to exhalations through gritted [pc.teeth] and groans of exertion. It feels like his knot is hollowing you out, the milodan refusing to let it rest anywhere outside of your ass and only giving you scant seconds to get used to its inflated bulk before he pulls it out and rams it back in.");
