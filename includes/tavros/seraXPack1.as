	...
	else if(response == "standard hand" || response == "standard oral" || response == "gurl hand" || response == "gurl oral")
	{
		...
		else
		{
			...
			else
			{
				...
				output("\n\n<i>“Goddamn,”</i> she husks ferally. She’s shifting you, forcing you to kneel and bend, pressing your [pc.butt] out to present your new sex to her. Her huge erection slides down your [pc.anus]. You’re either still too spaced out to stop her or you don’t want her to stop; some heady combination of the two. <i>“You know how cute you sound now? I’m gonna make you sing a symphony for me.”</i> Her thick bulb presses against your moist new entrance. It feels ridiculously, ludicrously big. There’s simply no way... Sera pushes in gently but determinedly and you tense up, your breath again catching in your throat as her beading head spreads your lips wide. She stops for a moment, recedes slightly, then extends herself again. Something gives in your pussy, a dull sliver of pain. <i>“Been so long since I did that,”</i> sighs the succubus with deep satisfaction. You grit your [pc.teeth] as she continues to gently dip in and out of you. She stretches you wider, and wider, and it feels like she must be tearing you apart - then with a wet sound her huge head fully enters you. You pant hard, your eyes crossing slightly as a comforting hand squeezes your [pc.butt].");
...
public function seraSexXXXhibitionBlowjob(arg:Array):void
{
	...
	else
	{
		if(pageNum == 1)
		{
			...
			output("\n\nYou grit your [pc.teeth] as, with a click, she turns the vibrations way up.");
			output("\n\n<i>“What do you say?”</i>");
			output("\n\n<i>“Th-thank you mistress,”</i> you manage, trying to keep your voice level despite the quakes now shaking irresistibly through your core.");
...
public function seraTongueFuckBonus():Boolean
{
	...
	output("\n\nHer clawed hands roughly grope your [pc.ass] as her lips mold into yours, plush breasts pooling against your [pc.chest]. You open your mouth, and for a moment taste her warm, smoky breath... and then that is replaced by her tongue, rearing past your [pc.teeth] and into your mouth like a snake that’s spotted something plump and furry in the bushes. It’s a prehensile beast that can easily wrap around yours, melding with it passionately, owning it and squeezing it in muffled, saliva-slathered embrace. But Sera isn’t interested in merely your mouth. Your [pc.eyes] widen as she bends in further, and with a filthy wet sound pushes her long tongue past your tonsils.");
