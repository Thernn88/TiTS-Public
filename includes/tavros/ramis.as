...
public function ramisDrink(response:String = "drink"):void
{
	...
	switch(response)
	{
		case "drink":
			...
			output("\n\n<i>“Nice one" + (pc.hasVagina() ? ". Show the boyos how it’s done" : "") + "!”</i> the big kaithrit gestures impatiently at the " + (rand(2) == 0 ? "bartender" : "barkeep") + ", who keeps pouring. <i>“So which part of the galaxy have you blown in from, then...?”</i>");
...
public function ramisFuck(response:String = "none"):void
{
	...
	switch(response)
	{
		...
		case "man":
			...
			output("\n\nThe vast expanses of brawny fawn goodness you’ve got your arm wrapped around have got you champing at the bit, and you’re happy to not go very far to get your [pc.teeth] into it. The love hotel she takes you to is not two hundred yards away, decorated in deep purples and reds, fully automated for discretion’s sake. You are just one of many whispering and giggling one night stands walking into it; the Milky Way is an unremittingly horny place.");
			...
			output("\n\nIt’s all you can do to suppress the urge to pull down the kaithrit’s jeans, lift her up and take her right there and then... but somehow you pull away when the lift doors open, and you " + (!pc.isNaga() ? "stumble" : "slither") + " to your room. The small scanner flicks over her eye and silently opens the door to your small, dimly lit suite. Equipped now with a good idea of what gets her going, you grip Ramis behind the knees and neck, grit your [pc.teeth] and lift all seven feet of her off the ground, drawing a delighted squeal as you " + (pc.hasLegs() ? "stagger" : "inch") + " forward and tumble her onto the bed (which groans in protest). Her teeth and eyes flash in the dark as she rips her own clothes off, her gaze slowly moving down your [pc.chest] as you stand over her");
