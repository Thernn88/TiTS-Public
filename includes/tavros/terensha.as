...
public function undertaleFootjob():void
{
	...
	if(pc.exhibitionism() < 33) output("grinding your [pc.teeth] to keep from moaning. You give sidelong glances to the crowd at the bar, wondering if any of them can see what’s going on under the table, even with the lights so low...");
...
public function tailPegStuffTimes():void
{
	...
	if(x >= 0)
	{
		...
		output("\n\nStill, you can already feel a little bubble of pre at the crown of Ren’s cock - the result of her excitement, or was she serious about how sensitive her tail is? With a grunt of effort, Ren pushes hard enough to force the bubble inside you, stretching your sphincter around a thin bulb of cum-swollen latex before her tapered crown follows it in. You grit your [pc.teeth], stifling a moan against the halfbreed whore’s lips when she pushes your asshole in.");
	}
	//else:
