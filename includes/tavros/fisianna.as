...
public function analFisiII(x:int):void
{
	...
	output(". After a few more moments, you can feel her walls slacken their hold on you just enough for you to continue. At a snail’s pace, you slide in again, gritting your [pc.teeth] against the incredible tightness that is Fisianna’s tailhole.");
...
public function fuckFisiSillyI():void
{
	...
	output(". Fisianna inwardly hisses and pushes her chest up and into you, forcing more of her soft mammary into your mouth. From there, you pull your [pc.lipsChaste] back to lightly clench her perky nipple between your [pc.teeth]. Gently, you pull on her bud, eliciting a squeal from your feline lover. You draw your [pc.tongue] to rub against the peachy bead between your [pc.teeth]. After a brief moment of this, you sink your head back down into Fisianna’s chest, though you don’t release her nipple from your clenched [pc.teeth]. Instead, you start to lightly grind them along the front of them, attempting to stimulate her sensitive melons.");
...
public function breedFisiIII(x:int):void
{
	...
	if (fisiPrurience() < 50) {
		...
		output("!!!”</i> Fisianna screams into her pillow, completely deaf to your pleas. Clenching your [pc.teeth] against an agonized groan of effort, you struggle to hold out against this incredible cockmilking, an unbearably pleasurable process designed by millions of years of evolution to force you to cum.");
