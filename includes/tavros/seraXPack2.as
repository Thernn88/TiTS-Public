...
public function seraBitchTrainingTease():void
{
	...
	else
	{
		...
		output("\n\nYou grit your [pc.teeth] and focus on working her pussy into a lather");
		if(chars["SERA"].hasCock()) output(" and her prick into a full, straining erection");
...
public function seranigansEvent(sEvent:String = "none"):void
{
	...
	switch(sEvent)
	{
		...
		case "credit":
			...
			output("\n\nYou grind your [pc.teeth] as you examine the damage done to your bank balance and credit rating. <i>Somebody</i> on your ship is gonna pay for this.");
