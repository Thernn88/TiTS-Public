...
public function turnDownRobotSexuals(opts:Array):void
{
	...
	output("\n\n<i>“Consent protocols not responding,”</i> says the sexbot, in the same tone of depthless calm. With a whir and the now-familiar sound of unwinding rope, four flexible tentacles tipped with rounded rubber grabbers appear out of its back. They sway restlessly around the eerily beautiful droid as it advances upon you. <i>“I am sorry, insert name here, but I cannot do that.”</i>");
...
public function yesToRobotSexBotFirstTime(tSexBot:Creature):void
{
	...
	output("\n\n<i>“Initiating sexy times,”</i> the sexbot agrees pleasantly. Your smile becomes slightly fixed as, with a whir and the now-familiar sound of unwinding rope, four flexible tentacles tipped with rounded rubber grippers appear out of its back. Before you can maybe rethink agreeing to this eerily beautiful droid, its warm synthetic skin and its many seeking, insistent hands are upon you.");
	//[go to loss scenes]
	clearMenu();
...
public function loseToSexBotAndHaveADick(cameFromMenu:Boolean = false):void
{
	...
	output("\n\n<i>“Foreplay at 75% completion.”</i>\n\nYou half-heartedly try and raise yourself off the ground, to do what you do not know; the sexbot makes hushing, soothing noises at the same time as two of its vigorously animated rope limbs swoosh down and pin you by the elbows to the floor. The tentacle attached like a limpet to your cock vibrates briskly, working up and down, sending delicious sensation buzzing through your groin. When it reaches the top it climbs delicately onto your bulging head and - you can’t stop yourself arching your back - envelopes it, plunging the sensitive end of your cock into a tight fleshlight center.");
	if(pc.hasVagina())
	{
		output(" You are given a full appreciation of just how wonderfully adaptable its tentacles are when you feel its final rubbery grabber pushing against [pc.oneVagina]. In one fluid movement it sheathes a heated steel dildo into you, buzzing with the same quiet vigor as the grapnel did traveling up and down your cock.");
	}
	...
	if(pc.cockTotal() == 1)
	{
		output("\n\nIts latex-clad butt touches your [pc.hips], and it thrums like an electric fan as it encompasses your manhood whole. Beyond a few centimeters of its opening the sexbot feels like packed, dry jelly, kneading your cock closely, a fleshlight with a mind of its own. It has molded its hole so it fits upon you like a glove. ");
		if(pc.cocks[x].cLength() < 6) output("Whatever line it was spinning to you earlier it has obviously drawn itself in, making its sex smaller - you doubt any human or alien would feel this tight around your sensitive, toy-like dick. When it begins to thrust its hips into you, you cannot help but groan, the sensation of its strong, close tunnels on your erection is that intense.");
	...
	else
	{
		...
		output("\n\nIts latex-clad butt touches your [pc.hips] as it encompasses your manhood whole. Beyond a few centimeters of its opening the sexbot feels like dry jelly, kneading your cocks closely, fleshlights with minds of their own. It has molded its holes so it fits upon you like a glove.");
		if(pc.cocks[x].cLength() < 6) output(" Whatever line it was spinning to you about your size it has obviously drawn itself in, making its sex smaller- you doubt any human or alien would feel this tight around your sensitive, toy-like dicks. When it begins to thrust its hips into you, you cannot help but groan, the sensation of its strong, close tunnels on your twin erections is that intense.");
		//[Cocks big: 
	...
	if(pc.hasVagina()) 
	{
		output("\n\nIt doesn’t take it long to calibrate the pulse needed to find the thousands of nerve endings in your [pc.vagina]. It packs your tunnel full of vibrations");
		if(pc.hasClit()) output(", [pc.oneClit] flicked and caressed by insistent electric fingers");
		output(" until you have moved from moans to screams, your female sex forced to orgasm again and again whilst your ");
...
public function femalePCsGetBangedByAFemBot(cameFromMenu:Boolean = false):void
{
	...
	output("\n\n<i>“That’s it, insert name here,”</i> it responds kindly. <i>“Just relax. When you relax it makes the interfacing that much smoother.”</i> This time the pulse is smaller, directed; vibrations are sent buzzing through your");
	if(pc.hasClit()) output(" [pc.clits]");
	else output(" groin");
	output(" and [pc.nipples], instantly and shockingly bringing you to orgasm, your [pc.vaginas] clenching and spurting around its thrusting dildo");
	if(y >= 0) output("es");
	...
	output(" it gets to it. It holds you close as it sends small pulses down the tentacock");
...
public function malebotDefeatsMalePCs(cameFromMenu:Boolean = false):void
{
	...
	output("\n\n<i>“Foreplay at 75% completion.”</i> You half-heartedly try and raise yourself off the ground, to do what you do not know; the sexbot makes a noise somewhere between a growl and a boiler’s throb as two of its vigorously animated rope limbs swoosh down and pin you by the elbows to the floor. The tentacle attached like a limpet to your cock vibrates briskly, working up and down, sending delicious sensation buzzing through your groin. When it reaches the top it climbs delicately onto your bulging head and - you can’t stop yourself arching your back - envelopes it, plunging the sensitive end of your cock into a tight fleshlight center.");
	output("\n\nYour attention taken by the pleasure ribbing your length, you barely notice the sexbot carefully maneuvering your [pc.legOrLegs] with its slim, strong hands to expose your [pc.butt], at least until its final tentacle comes to rest on the pad of your [pc.asshole] and it smoothly unsheathes a vibrating steel dildo from its center, insistently pushing into your hole.");
	...
	output("\n\n<i>“Foreplay completed. Rapport matrices engaged,”</i> it sighs. The dildo in your ass is withdrawn and the tentacle wringing your [pc.cock " + x + "] slows to a sensual suck. A new pressure, thicker and warmer, is placed against your opened [pc.asshole]. The sexbot’s eyes glow brighter as it looks down at you, held tight with its warm, obdurate limbs. <i>“Damn, you are one good looking [pc.guy], insert name here. Clients like you make me glad I was programmed to perform this task. I only wish I could take you home so I could do this to you over and over!”</i> The worst part is that it inserts enough boyish enthusiasm and bonhomie into its tone to make you want to believe it.");
...
public function loseToManBotWhenHavingAPussy(cameFromMenu:Boolean = false):void
{
	...
	output("\n\n<i>“Foreplay at 75% completion.”</i> You half-heartedly try and raise yourself off the ground, to do what you do not know; the sexbot makes a noise somewhere between a growl and a boiler’s throb as two of its vigorously animated rope limbs swoosh down and pin you by the elbows to the floor. The tentacle attached to your pussy");
	if(pc.hasClit()) output(" touches [pc.oneClit], gently shifting");
	else output(" gently shifts");
	output(" over it as the whole appendage vibrates. Only when your hole has been coaxed into a froth of excitement does it unsheathe a dildo from its hollow core, sliding smoothly into you, carrying the delicious quakes further and further into your core.");
	...
	if(pc.hasCock()) 
	{
		output(" Its final writhing limb-hose lands on your [pc.cock " + x + "], vibrating briskly, working up and down, sending delicious sensation buzzing through your groin. When it reaches the top it climbs delicately onto your bulging head and - you can’t stop yourself arching your back - envelopes it, plunging the sensitive end of your cock into a tight fleshlight center.");
		pc.cockChange(true,false);
	}
	...
	else 
	{
		...
		if(pc.hasClit()) output(" as the one teasing your [pc.clit]");
		output(" is pushing open the entrance to your [pc.vagina " + y + "]. You are far too relaxed and unfurled to offer any resistance to it sliding its girthed, steel lengths into the openings it has claimed.");
	...
	output("\n\n<i>“Just relax. When you relax it makes the interfacing that much smoother.”</i> This time the pulse is smaller, directed; vibrations are sent buzzing through your");
	if(pc.hasClit()) output(" [pc.clit]");
	else output(" groin");
	output(" and [pc.nipples], instantly and shockingly bringing you to orgasm, your [pc.vaginas] clenching and spurting around its thrusting cock");
	if(y >= 0) output("s");
	...
	output("\n\n<i>“Scanning in progress”</i>, you think you hear it calmly state in amongst the endlessly shifting, torturing pleasure but it could have said anything - hell, YOU could have said it, you’re that much of a passenger in your own body. You are however dimly aware of what it’s building towards and finally");
	if(pc.hasClit()) output(", after softly teasing your [pc.clit] with tiny charges for a time,");
	output(" it gets to it. It holds you close as it sends small pulses down its cock");
	if(y >= 0) output("s");
...
public function consentaclesVictoryWithDannySexBot():void
{
	...
	output("\n\nAfter a moment’s pause, the white-clad android extends its four fibrous limbs from its back with a whir. They hang idly in the air in front of you, and then, with a smooth click, they each sprout a stainless, six-inch dildo from their hollow centers. Another moment’s pause and then, with a click and an electric-toothbrush hum, they begin to vibrate busily.");
	...
	output("\n\nYour laughter turns to coos as the dizzying motion comes to a stop and a warm buzz lands on your");
	if(pc.hasClit()) output(" [pc.clit]. The sexbot moves its free dildo across your clit with gradual, considered passes, circling your bud before slowly sliding over it each time");
	else output(" pubic mound. The sexbot moves its free dildo across your mons, massaging it");
	output(" until the sensation has blossomed from pleasure to delight, your [pc.vagina " + x + "] first softening and then ");
	if(pc.wetness() <= 3) output("beading");
	else output("gushing");
	output(" lubricant to the persistent motion. You thrust your [pc.hips] outwards impatiently and immediately the sexbot moves on, rolling its warm, vibrating tool");
	if(pc.hasClit()) output(" once more over your [pc.clit]");
	else output(" along your labia teasingly");
	output(" before descending, spearing straight into your hole with a satisfying squelch.");
	pc.cuntChange(x,25,true,true,false);
...
public function blowjobVictoryFromSexbot():void
{
	...
	if(pc.balls > 0) 
	{
		output(" It cups into your groin with its other hand, cradling your [pc.balls], giving you a gentle squeeze at measured intervals. Again, the fact its movements are precisely timed does not change the fact that it feels very good indeed. You find yourself wondering whether the android’s ball-massaging technique was peer reviewed before release and almost laugh.");
	}
...
public function dogEStyleWithSexBots():void
{
	...
	else
	{
		...
		output("\n\n<i>“Hey. Sweetheart? Mute.”</i> Its manufactured dirty talk switches off in mid-moan, and your rough coupling goes back to being soundtracked by the squeak of distressed latex. Without its voice on, you find yourself paying closer attention to its background noise – the hum of its power source, the click and whir of its subsystems as it reacts to your dick driving into its innards. Its humming builds slightly and it makes a small, almost imperceptible dry hovering sound at the apex of each thrust.");
