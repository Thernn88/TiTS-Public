...
public function testDriveArmorsForShit():void
{
	...
	output("\n\n<i>“Here we go... yeah, this should be fun,”</i> she says, pulling out an armload of firearms and dropping them onto the coffee table with a loud, echoing clatter that makes your [pc.teeth] ache. With a grin, she prances off down another corridor leading off from the chamber, and returns with a pair of dummies under each arm, both with several bullet holes and scorch marks across their bodies. <i>“[pc.name], meet Bob and Bobber. They’re going to be showing us why we wear shield belts and armor these days, aren’t you, boys?”</i>");
...
public function putItInAnnosButtYouSloot():void
{
	...
	output("\n\n<i>“Oooh, that felt good,”</i> Anno purrs, tail flicking up to brush the tip of your nose. You catch the very tip in your [pc.teeth], giving it a playful shake - and feeling the ramifications in your cock as her ass jiggles in response. Shooting you a grin over her shoulder, Anno reaches back and grabs one of her own cheeks, holding herself open and inviting for you. <i>“Keep it coming, boss. I’m starting to enjoy this...”</i>");
