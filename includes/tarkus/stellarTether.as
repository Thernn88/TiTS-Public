...
public function hackTheRocketPodsOnTarkus():void
{
	...
	{
		output("\n\nYou spend a few minutes tapping around in the security system, but someone’s clearly been ramping up the anti-intruder countermeasures. You grit your [pc.teeth] with effort, trying to pierce the security, but finding no backdoors or weak points to exploit. With a grunt of frustration, you toss your Codex back in your pack. Looks like it’s the hard way.");
		processTime(2);
		clearMenu();
		configRocketFight();
		addButton(0, "Next", CombatManager.beginCombat);
...
public function dickFuckDatThraggenCoochie():void
{
	...
	output("\n\nNow it’s your turn. You lean in through the splayed gulf of her groin, deep enough to grab one of the dark teats atop Khorgan’s breasts between your [pc.teeth], rolling the pert bud between your incisors until the captain groans with pleasure, vaginal muscles tensing around your thrusting prick. At this angle, though, no matter how tight she clenches, you’ve got the perfect vantage to pound her pussy. Your hips piston forward, slamming home against her up-raised cheeks with enough force to make her whole body tremble, her hefty tits bouncing hypnotically with every thrust.");
