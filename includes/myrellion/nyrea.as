...
public function rideNyreaDick():void
{
	...
	output(" of your "+ tHoleTag +", hammering against your hole in demand of entry. The urge to feel that mass of muscular, throbbing cockflesh in you is too great: you grit your [pc.teeth] and sink down, forcing yourself to take the huntress’s knot.");
...
public function pcLossToNyreaAdditionalOne():void
{
	...
	else if (pc.hasGenitals())
	{
		...
		if (!isFull)
		{
			...
			output("\n\n<i>“See? Isn’t it – wonderful – offworlder? To be fucked – full of my eggs?”</i> The huntress inquires between grunts of effort and pleasure, clearly not expecting a coherent answer out of your gritted [pc.teeth]. <i>“You’ll never – go empty again – if you submit.”</i>");
			pc.loadInCunt(enemy, tHole);
			pData = pc.getPregnancyOfType("NyreaEggPregnancy");
			output("\n\n");
