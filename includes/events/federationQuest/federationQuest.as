...
public function fedQuestDepart():void
{
	...
	output("\n\n<i>“Yes sergeant!”</i> the commandos shout back, half drowned-out by the sudden roar of the engines. A thrumming vibration runs through the bed of the armored vehicle. Somehow this ancient-looking iron beast feels like it’s shaking harder than a ship about to make a LightDrive jump -- you grip your harness tighter and grit your [pc.teeth], just hoping that growing howl from up front doesn’t turn into an explosion.");
