...
public function PKTSYLT(args:Array):void
{
	...
	output("\n\nYou clench your [pc.teeth]. You’re not sure if you can put the pleasure you’re feeling to words, but maybe you don’t need to, and they’ll settle for a loud, drawn out groan or something. When your orgasm hits you, it’s about all you could hope to achieve.");
	processTime(20);
	pc.lust(100);
	clearMenu();
...
public function PKTSPCU(args:Array):void
{
	...
	else
	{
		...
		output("\n\nYou have a difficult time adding much more to Paige’s begging, as close as you are; your [pc.teeth] chew on your lips in orgasmic bliss as your [pc.clit] fires signal after signal to your head and your [pc.vagina] about your impending orgasm. Gods, if only you had a cock inside you right now....");
