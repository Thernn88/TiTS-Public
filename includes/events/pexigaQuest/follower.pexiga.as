...
public function firstTimePexibuttMilkingForLadyTypes3():void
{
	...
	output("\n\nLike a live wire on an exposed nerve, the buzzing translator starts overloading your system. your [pc.teeth] bite hard enough on your lower lip to leave an imprint and you ");
...
public function faceFuckDatPexigaFaceRingGagThingMaybe(x:int):void
{
	...
	output("\n\nClenching your [pc.teeth], you shift one trembling hand to grab the underside of the girl’s jaw and use the extra leverage to completely cut loose. Fucking her face with a bestial vigor, you slam into her with all the strength you can muster. The table she’s braced against sways and creaks with the intensity of your effort, while thick webs of gooey drool creep down her gag and splatter across her lower body like a translucent glaze. A knot of burning tension builds inside your chest as your muscles tighten with the raw physicality of your oral assault. ");
	if(pc.totalCocks() > 1) 
	{
...
public function eatOutPexigoo3():void
{
	...
	output("\n\nThe silver girl clenches her thighs around your head, her heels battering your back as she kicks and squirms in moaning delight. The pressure on your temples is incredible and, in reflex, you bite down on her fat, white vulva, your [pc.teeth] clenching hard enough to leave an imprint. She responds immediately, easing up on her tension and sliding forward, pressing her loins against your nose as if in apology. She tries to say something, but her gold voice spheres are presently inside Yammi’s creaming cunt and whatever [pexiga.name] had to say is drowned out by the cook’s peaking wail of climactic ecstasy.");
...
public function bubbleBuddyPexiga2():void
{
	...
	if(pc.cumQ() >= 10000)
	{
		output("\n\nYou clench your [pc.teeth] and wipe the sweat from your brow. Now that you’ve gotten into a proper pace, you can really give her all you’ve got. The heavy, liquid orb bulging atop [pexiga.name]’s breasts positively dwarfs the F-cups, weighing her down to a sitting position. The latex membrane grows paler and paler as it stretches to hold the tremendous volume of your seemingly endless orgasm. The pliant rubber contorts across her supple form, until your pexiga’s upper body is lost under the vaguely [pc.cumColor] hued beach ball of your thick cum.");
...
public function tooBigPexigaFacefuck2(x:int):void
{
	...
	if(pc.cocks[x].cLength() < 36)
	{
		...
		output(" You head rolls back, your fingers lose their strength, and ragged, panting gasps tear their way past clenched [pc.teeth].");
