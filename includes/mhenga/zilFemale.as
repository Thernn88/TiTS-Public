...
public function suckleFuckZilFemaleYouSuckleFucker():void {
	...
	output("\n\nHer breath is ragged and heavy by the time the zil’s taken everything you have. With arms still locked around your neck, she pulls herself into a long, deep kiss with you. Your lips part, admitting a long, thick yellow tongue which searches into your maw, playing across your [pc.teeth] and throat.");
...
public function tribAndSuckZil():void {
	...
	output("\n\nSuddenly, your eyes widen as her long, smooth digit pushes right into your [pc.asshole]. You gasp silently, honey drooling from your lips as one, then two of the zil’s fingers delve your backside, swirling around inside your puckered hole. <i>“Don’t you dare hold back now, stranger. Cum for me,”</i> the zil whispers, spearing you hard on her fingers as her hips buck hard into yours. Your grit your [pc.teeth], refusing to give in so easily. She’ll have to work a little harder than that to get you to peak first. <i>“Is that so? Well, let’s see...”</i> the zil girl chuckles as you feel a momentary jab in your thigh.");
...
public function fZilPregFeed():void
{
	...
	output("\n\nYou grab fistfuls of dirt and grass, thrusting your hips into the air and gritting your [pc.teeth]. <i>“Cumming!”</i> you grunt, giving the zil just enough warning that she’s able to pull her tongue away and open her mouth wide.");
	if(pc.cumQ() >= 5000)
	{
