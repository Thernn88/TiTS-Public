...
public function eatOutKellysQuoteUnquoteCunny(onCouch:Boolean = false):void
{
	...
	else if(pc.isMischievous())
	{
		...
		output("\n\nKelly tries instinctively to squeeze your finger between her luscious buttcheeks, but in her position, she can’t really manage it. <i>“Ah! ...Is that the best you got? N-nng!-Nothing special yet,”</i> she pants, moaning as you delicately scrape the very tip of her little button with your [pc.teeth].");
	...
	else
	{
		...
		output("\n\nThe laquine lets out a squeal and wriggles on the table as your [pc.teeth] close on her skin, though a giggle escapes her despite her efforts to stifle it. Her cunt squeezes you, as if anxious to milk your fingers of cum that they don’t have, her eyes closed as if to heighten her resolve.");
