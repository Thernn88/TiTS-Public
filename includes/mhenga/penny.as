...
public function gardeFordWritesPennySmex():void {
	...
	if (pc.hasCock()) 
	{
		output("\n\nPenny moans numbly as you thrust faster and faster between her legs. You grit your [pc.teeth] as you cum, adding your fluids to the veritable pool of sexual liquid.");
		if(pc.hasVagina()) 
		{
