...
public function giveBurtABJ():void {
	...
	output("\n\nBurt groans out, <i>“Oh [pc.name]....”</i> and then without warning his hands grip your [pc.hair] tightly and he pulls forward, forcing your jaw to stretch almost painfully around the nearly five inch thick shaft, but it is clear that his mechanical cock is immune to the scrape of your [pc.teeth]. Your [pc.tongue] tries to push against the invasion, but that just spurs Burt on further. He shudders in pleasure and pushes slowly deeper into your mouth.");
...
public function burtSticksItInThePCsVajayjay():void {
	...
	if(pc.isNaga() || pc.legCount <= 1)
	{
		...
		if(pc.vaginas[x].looseness() <= 2) output("\n\nYou grit your [pc.teeth] as Burt starts to press his hips forward, slowly forcing your [pc.vagina " + x + "] to spread open for his broad flare, stretching you vulgarly as he slowly sinks that tool into you.");
	...
	//[if (biped = true)]
		...
		//if (vagCapacity = tight)
		if(pc.vaginas[x].looseness() <= 2) output(" You grit your [pc.teeth] as Burt starts to press his hips forward, slowly forcing your [pc.vagina " + x + "] to spread open for his broad flare, stretching you vulgarly as he slowly sinks that tool into you.");
		//if (vagCapacity = medium)
