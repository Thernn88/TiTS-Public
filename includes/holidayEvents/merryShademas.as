...
public function cleanUpWithShade():void
{
	...
	else
	{
		...
		if(x >= 0)
		{
			...
			if(pc.hasAbdominalSexOrgan()) output("squirms between your [pc.legs], searching out the abdominal appendage. Your [pc.abdCock] is soon engulfed in Shade’s tail, sliding deep into her drooling pussy-slit.");
